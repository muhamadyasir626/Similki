        ...
        <div id="wizard">
          ...
          <section>
            ...
            <div class="text-fields wilayah_upt" style=" margin: 10px 0px; padding-bottom:10px;">
              ...
              <select id="wilayah_upt" class="option-input upt-wilayah" name="wilayah_upt" style="width:400px; padding:10px;" required>
            ...
            <form id="stage2" action="" method="POST">
              @csrf
            ...
            <div id="form-tahun_izin" style="margin-bottom:10px; padding-bottom:10px;">
              <h5 style="margin-bottom: 8px; padding-top:10px;">Tahun Izin</h5>
              <span class="error-message" style="color: red; display: none;"></span>
