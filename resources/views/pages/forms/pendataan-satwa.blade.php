        ...
        <div id="wizard">
          ...
          <section>
           ...
           @if ($user->role && $user->role->tag == 'LK')           
            ...
            {{-- JENIS KOLEKSI SATWA --}}
              <div id="form-satwa_koleksi" style="margin-bottom: 10px">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="satwa_koleksi" id="satwa_koleksi" value="Ya" required>
                  <label class="form-check-label">
                    Satwa Hidup
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="satwa_koleksi" id="satwa_koleksi" value="Tidak" required>
                  <label class="form-check-label">
                    Satwa Awetan
                  </label>
                </div>
            ...
            <div id="form-jenis_koleksi">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="jenis_koleksi" id="jenis_koleksi" required>
                <label class="form-check-label">
                  Satwa Koleksi
                </label>
              </div>
            ...
            <div id="form-asal_satwa">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="asal_satwa" id="asal_satwa" value="Ya" required>
                <label class="form-check-label">
                  Endemik (Asli Indonesia)
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="asal_satwa" id="asal_satwa" value="Tidak" required>
                <label class="form-check-label">
            ...
            <div id="form-status_perlindungan" style="display: none">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perlindungan" id="status_perlindungan" value="Ya" required>
                <label class="form-check-label">
                  Ya, statusnya dilindungi
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="status_perlindungan" id="status_perlindungan" value="Tidak" required>
                <label class="form-check-label">
                  Tidak
                </label>
              </div>
            ...
            <div id="form-pengambilan_satwa">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="pengambilan_satwa" id="pengambilan_satwa" value="Ya" required>
                <label class="form-check-label">
                  Ya, satwa diambil dari alam
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="pengambilan_satwa" id="pengambilan_satwa" value="Tidak" required>
                <label class="form-check-label">
                  Tidak
                </label>
              </div>
          ...
          <section>          
            ...
            <div id="form-perilaku_satwa" style="margin-bottom: 10px">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="perilaku_satwa" id="perilaku_satwa" value="Ya" required>
                <label class="form-check-label">
                  Ya
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="perilaku_satwa" id="perilaku_satwa" value="Tidak" required>
                <label class="form-check-label">
                  Tidak
                </label>
              </div>
            ...
            <div id="form-jenis_kelamin" style="margin-bottom: 10px">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin" value="Ya" required>
                <label class="form-check-label">
                  Jantan
                </label>
              </div>
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin" value="Tidak" required>
                <label class="form-check-label">
                  Belum diketahui
                </label>
              </div>
           ...
           {{-- JENIS TAGGING --}}
            <div id="form-jenis_tagging" style="margin-bottom:10px; padding-bottom:10px;">
              ...
              <div style="display: flex; gap: 10px;">
                ...
                <input type="text" name="kode_tagging" id="kode_tagging" placeholder="Kode Tagging" style="width: 180px; padding:10px;" min="0" required>
              </div>
            </div>
            ...
            <div id="takson_hewan" class="takson-hewan" style="padding-bottom: 20px;">
              ...
              <div style="display: flex; gap: 10px;">
                ...
                <select name="genus" id="genus" style="width: 180px; padding:10px;" required>
                  ...
                  <!-- Tambahkan opsi genus lainnya di sini -->
                </select>
                ...
                <select name="sub_species" id="sub_species" style="width: 180px; padding:10px;" required>
                  ...
                  <!-- Tambahkan opsi sub spesies lainnya di sini -->
                </select>
              </div>
            </div>
