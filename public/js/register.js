...
function updateStageIndicators() {
    if (completedStages.includes("stage1")) {
        ...
        document.querySelector(".stageno-1").style = "";
    }

    if (completedStages.includes("stage2")) {
        ...
        document.querySelector(".stageno-2").style = "";
    }
}

// Transition functions with localStorage updates
function stage1to2() {
...
function stage2to1() {
    ...
    completedStages = completedStages.filter((stage) => stage !== "stage1");
    updateStageIndicators();
    saveCurrentStage("stage1");
}
...
function stage2to3() {
    ...
    if (!completedStages.includes("stage2")) {
        completedStages.push("stage2");
    }
    updateStageIndicators();
    saveCurrentStage("stage3");
}
...
function stage3to2() {
    ...
    completedStages = completedStages.filter((stage) => stage !== "stage2");
    updateStageIndicators();
    saveCurrentStage("stage2");
}
