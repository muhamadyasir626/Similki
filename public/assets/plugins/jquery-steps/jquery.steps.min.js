...
!(function (a, b) {
    ...
    // function h(a, b) {
    //     var c = jQuery(a).find(".steps li").eq(b.currentIndex);

    //     if (jQuery(a).triggerHandler("finishing", [b.currentIndex])) {
    //         c.addClass("done").removeClass("error");

    //         // Menangkap semua data form
    //         var formData = {};
    //         jQuery(a).find("input, select, textarea").each(function () {
    ...
    //         // Memicu event "finished"
    //         jQuery(a).triggerHandler("finished", [b.currentIndex]);
    //     } else {
    //         c.addClass("error");
    //     }
    // }
    ...
    //         // Capture all form data from pendataan1, pendataan2, and pendataan3
    //         var formData = {};

    //         // Append data from pendataan1
    //         jQuery("#pendataan1")
    ...
    //         jQuery.ajax({
    //             url: "/satwa/store", // Use the actual route URL
    //             type: "POST",
    //             data: formData, // Send combined form data
    //             headers: {
    ...
    //                     window.location.href = "/success-route"; // Adjust to your success route
    //                 } else {
    //                     alert("There was an error submitting the form.");
    //                     console.error(response.errors); // Log errors for debugging
    //                 }
    //             },
    ...
    //         // Submit form data using AJAX
    //         jQuery.ajax({
    //             url: "/satwas", // Ganti dengan rute Laravel yang sesuai
    //             type: "POST",
    ...
    //                     window.location.href = "/success-route"; // Ganti dengan rute sukses yang sesuai
    //                 } else {
    //                     alert("There was an error submitting the form.");
    //                     console.error(response.errors); // Log error untuk debugging
    //                 }
    //             },
    //             error: function (xhr, status, error) {
    //                 console.log("Error:", error);
